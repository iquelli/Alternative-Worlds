...
\end{titlepage}
  ...
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{assets/logo.jpg}
    \captionof{figure}{Logo for a genetic modification lab}
  \end{minipage}
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{assets/instituição.jpg}
    \captionof{figure}{Futuristic Genetic Laboratory}
  \end{minipage}

  \section{Objeto}

  A técnica CRISPR foi uma das maiores descobertas da década de 20. Despertou um interesse mundial e cientistas de todo o mundo dedicaram-se ao desenvolvimento desta para usos diversos. A CRISPR/Cas9 foi um trabalho merecedor de um prémio Nobel, e esta consiste no uso de uma enzima que atua como “tesoura” molecular e elimina, suprime ou modifica uma determinada sequência de genes. Esta sequência é determinada em laboratório e cada doença genética tem uma específica. 
  
  A C-Lab foi fundada com o objetivo de tornar a edição genética mais acessível à população, e com isso, os investigadores procuraram formas de esta técnica ser ingerida, mantendo a sua eficácia. Consideraram injeções, tratamentos, entre outros, à procura da forma mais intuitiva e simples para as pessoas,  
  
  Após longos anos de trabalho, os cientistas conseguiram finalmente implementar esta técnica em comprimidos. Foi um trabalho de tentativa e erro, com muitas frustrações mas finalmente alcançaram aquilo que promete ser a tecnologia mais importante na história da ciência.
 
  Primeiramente é necessário a recolha do material genético. Para este efeito recorreu-se à recolha de saliva, com o uso de um swab, uma espécie de cotonete alongado, um processo simples e não tão invasivo como se fosse recolha de sangue, por exemplo. 
 
  Para que se efetue a separação do DNA dos outros componentes da saliva, é crucial esfregar o swab num dos frascos disponíveis no kit. O frasco indicado varia conforme o 23º par cromossómico. Para indivíduos do sexo masculino, o par é XY e o frasco indicado é o 56m-lg. Enquanto que para pessoas do sexo feminino, XX, é usado o frasco 32l-mn. Após o esfregaço, é usada uma pipeta de Pasteur para pipetar até ao traço o conteúdo do frasco para o suporte da fita indicadora. Quando realizado este passo, coloca-se a fita dentro do respetivo suporte e aguarda-se pelo resultado.
  
  No kit, para cada cor apresentada na fita indicadora, há uma doença genética associada.  As doenças que podem ser identificadas pelo kit são as mais comuns e a doença apresentada é a mais predominante e não impede a existência de outras. Para um teste mais completo é necessária a marcação e deslocação a um centro da C-Lab para o estudo total. Esta marcação pode ser efetuada online através de um formulário no site do instituto. 
  
  Este teste tem uma exatidão de cerca de 80\%, o que revela ainda um trabalho a elaborar para que este kit seja totalmente eficaz. 

  \subsection{Documentação do objeto}

  Vamos agora descrever o processo de construção do nosso objeto para o representar durante a nossa apresentação em aula.
  
  Começamos primeiramente por fazer vários sketchs, sendo o que achamos mais apelativo o seguinte:

  \begin{minipage}{1\textwidth}
    \centering
    \includegraphics[width=0.6\linewidth]{assets/sketch.jpg}
    \captionof{figure}{O nosso sketch escolhido}
  \end{minipage}

  A paleta de cores utilizada foi preto para a estrutura de suporte e os restantes objetos encaixam-se dentro dos tons do nosso logo.

  Utilizou-se uma caixa de madeira que foi posteriormente pintada com tinta spray preta de forma a dar um ar monocromático à estrutura. Para encaixar os materiais como os frascos e a caixa de comprimidos, utilizamos camadas de esferovite pintadas com tinta acrílica preta e uma camada de cola com brilhos verdes e para colar os swabs e o suporte do pH usamos massa adesiva branca, para ser possível retirar com facilidade.
  
  Temos aqui umas fotografias do nosso processo de construção da caixa: 

  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.5\linewidth]{assets/construção1.jpg}
    \captionof{figure}{Construção do objeto}
  \end{minipage}
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.5\linewidth]{assets/construção.jpg}
    \captionof{figure}{Construção do objeto II}
  \end{minipage}


  Na parte experimental, recorremos a laboratórios do IST para a recolha de material como os frascos, swabs, fitas indicadoras de pH e a pipeta de Pasteur. Um dos frascos contém vinagre, um líquido de carácter  ácido, para atribuir uma cor amarelada. No outro, foi inserida lixívia, uma mistura básica que altera a cor do indicador para vermelho escuro. Após vários experimentos, a saliva só por si não alterava a cor da fita, pelo que recorremos a estes componentes para o efeito. 
   
  Os comprimidos são caseiros, constituídos por uma mistura de farinha, açúcar e chá de hibisco para os comprimidos vermelhos, açafrão para os amarelos e cenoura para os laranjas, portanto, totalmente comestíveis. 

  \begin{minipage}{1\textwidth}
    \centering
    \includegraphics[width=0.3\linewidth]{assets/comprimidos.jpg}
    \captionof{figure}{Os comprimidos}
  \end{minipage}

  Deste modo, ficou assim o nosso objeto final:

  \begin{minipage}{1\textwidth}
    \centering
    \includegraphics[width=0.6\linewidth]{assets/objeto-final.jpg}
    \captionof{figure}{O nosso objeto final}
  \end{minipage}

  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.7\linewidth]{assets/obj-lab.jpg}
    \captionof{figure}{Objeto a ser utilizado}
  \end{minipage}%
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.7\linewidth]{assets/objeto-trás.jpg}
    \captionof{figure}{Vista da parte de trás do objeto}
  \end{minipage}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \captionof{figure}{Fashion in the future}
  \end{minipage}%
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{assets/PurityKeepers.jpg}
    \captionof{figure}{Catholic conservative people in a futuristic scenario}
  \end{minipage}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \captionof{figure}{Inhabited Antartica}
  \end{minipage}%
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{assets/Deserto_Sahara.png}
    \captionof{figure}{Sahara desert with people}
  \end{minipage}
  ...
  A euforia inicial que envolveu a descoberta de Jiankiu rapidamente deu lugar a uma realidade mais sombria. Para o desgosto do cientista, nem tudo foi um mar de rosas. A manipulação genética, apesar das suas promessas, trouxe consigo uma 
   ...
   \subsection{Discriminação}
    ...
    Havia uma divisão entre a corrente negacionista em oposição à corrente filosófica do transumanismo.$^{[4]}$
    ...
    Por outro lado, a ausência de deficiências tornou-se o modelo de normalidade, o que levou ao preconceito contra pessoas com alguma deficiência.$^{[1]}$
   ...
   \subsection{Resultados de uma Operação Mal Realizada}
    ...
    a agricultura e outras formas de vida vegetal.$^{[1]}$
  ...
  Recentemente, a República Popular da China reviu a sua legislação no que concerne à modificação genética, permitindo alterações ao ADN com o intuito de imunizar contra determinadas doenças em seres humanos.$^{[2]}$
  ...
  \begin{thebibliography}{9} % O argumento indica o número máximo de entradas que você espera ter. Se você tem mais de 9, use 99.
    ...
    \bibitem{ExemploRef}
    SNS (2016). \textit{Doenças genéticas}, \url{https://www.insa.min-saude.pt/doencas-geneticas/}

    \bibitem{ExemploRef}
    Público (2023). \textit{Já se sabe o que está a fazer o cientista chinês que mudou o ADN de bebés}, \url{https://www.publico.pt/2023/01/11/ciencia/noticia/ja-sabe-cientista-chines-mudou-adn-bebes-2034606}

    \bibitem{ExemploRef}
    Iberdola (2020). \textit{CRISPR: a grande revolução genética}, \url{https://www.iberdrola.com/inovacao/modificacao-genetica-crispr}

    \bibitem{ExemploRef}
    Publico (2021). \textit{Teste genético português ajuda a tratar doenças com uma gota de saliva}, \url{https://www.publico.pt/2021/01/22/ciencia/noticia/teste-genetico-portugues-ajuda-tratar-doencas-gota-saliva-1947292}
